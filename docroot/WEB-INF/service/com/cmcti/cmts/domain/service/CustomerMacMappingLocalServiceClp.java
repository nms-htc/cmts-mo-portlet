 ...
 * @generated
 */
public class CustomerMacMappingLocalServiceClp
	implements CustomerMacMappingLocalService {
	public CustomerMacMappingLocalServiceClp(
	...
	public com.cmcti.cmts.domain.model.CustomerMacMapping addCustomerMacMapping(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(customerMacMapping)
					});
		}
		catch (Throwable t) {
	...
	public com.cmcti.cmts.domain.model.CustomerMacMapping createCustomerMacMapping(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { customerMacId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.cmcti.cmts.domain.model.CustomerMacMapping deleteCustomerMacMapping(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { customerMacId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.cmcti.cmts.domain.model.CustomerMacMapping fetchCustomerMacMapping(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { customerMacId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.cmcti.cmts.domain.model.CustomerMacMapping getCustomerMacMapping(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName11,
					_methodParameterTypes11, new Object[] { customerMacId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<com.cmcti.cmts.domain.model.CustomerMacMapping> getCustomerMacMappings(
		...
		return (java.util.List<com.cmcti.cmts.domain.model.CustomerMacMapping>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public com.cmcti.cmts.domain.model.CustomerMacMapping getByMacAddress(
		...
		try {
			...
			if (t instanceof com.cmcti.cmts.domain.NoSuchCustomerMacMappingException) {
				throw (com.cmcti.cmts.domain.NoSuchCustomerMacMappingException)t;
			}
