...
/**
 * Provides the local service interface for Option. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author richard
 * @see OptionLocalServiceUtil
...
public interface OptionLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OptionLocalServiceUtil} to access the option local service. Add custom service methods to {@link com.cmcti.cmts.domain.service.impl.OptionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
