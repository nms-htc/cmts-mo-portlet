...
/**
 * The persistence utility for the customer mac mapping service. This utility wraps {@link CustomerMacMappingPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class CustomerMacMappingUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(CustomerMacMapping customerMacMapping) {
		getPersistence().clearCache(customerMacMapping);
	}
	 ...
	 */
	public static List<CustomerMacMapping> findWithDynamicQuery(
	 ...
	 */
	public static CustomerMacMapping update(
		CustomerMacMapping customerMacMapping) throws SystemException {
		return getPersistence().update(customerMacMapping);
	}
	 ...
	 */
	public static CustomerMacMapping update(
		CustomerMacMapping customerMacMapping, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(customerMacMapping, serviceContext);
	}
	...
	*/
	public static java.util.List<com.cmcti.cmts.domain.model.CustomerMacMapping> findByUser(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.cmcti.cmts.domain.model.CustomerMacMapping findByUser_First(
		long userId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.cmcti.cmts.domain.model.CustomerMacMapping fetchByUser_First(
		long userId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.cmcti.cmts.domain.model.CustomerMacMapping findByUser_Last(
		long userId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.cmcti.cmts.domain.NoSuchCustomerMacMappingException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.cmcti.cmts.domain.model.CustomerMacMapping fetchByUser_Last(
		long userId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.cmcti.cmts.domain.model.CustomerMacMapping[] findByUser_PrevAndNext(
		long customerMacId, long userId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.cmcti.cmts.domain.NoSuchCustomerMacMappingException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
				   .findByUser_PrevAndNext(customerMacId, userId,
			orderByComparator);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(customerMacMapping);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(customerMacMappings);
	}
	...
	*/
	public static com.cmcti.cmts.domain.model.CustomerMacMapping create(
		long customerMacId) {
		return getPersistence().create(customerMacId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.cmcti.cmts.domain.model.CustomerMacMapping remove(
		long customerMacId)
		throws com.cmcti.cmts.domain.NoSuchCustomerMacMappingException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(customerMacId);
	}

	public static com.cmcti.cmts.domain.model.CustomerMacMapping updateImpl(
		com.cmcti.cmts.domain.model.CustomerMacMapping customerMacMapping)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(customerMacMapping);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.cmcti.cmts.domain.model.CustomerMacMapping findByPrimaryKey(
		long customerMacId)
		throws com.cmcti.cmts.domain.NoSuchCustomerMacMappingException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(customerMacId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.cmcti.cmts.domain.model.CustomerMacMapping fetchByPrimaryKey(
		long customerMacId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(customerMacId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.cmcti.cmts.domain.model.CustomerMacMapping> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static CustomerMacMappingPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (CustomerMacMappingPersistence)PortletBeanLocatorUtil.locate(com.cmcti.cmts.domain.service.ClpSerializer.getServletContextName(),
					CustomerMacMappingPersistence.class.getName());

			ReferenceRegistry.registerReference(CustomerMacMappingUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(CustomerMacMappingPersistence persistence) {
	}

	private static CustomerMacMappingPersistence _persistence;
}