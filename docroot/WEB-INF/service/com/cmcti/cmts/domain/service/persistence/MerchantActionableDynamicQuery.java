 ...
 * @generated
 */
public abstract class MerchantActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public MerchantActionableDynamicQuery() throws SystemException {
		setBaseLocalService(MerchantLocalServiceUtil.getService());
		setClass(Merchant.class);

		setClassLoader(com.cmcti.cmts.domain.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("merchantId");
	}
}