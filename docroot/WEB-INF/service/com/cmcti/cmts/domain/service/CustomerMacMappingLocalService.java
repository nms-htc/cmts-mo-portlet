...
/**
 * Provides the local service interface for CustomerMacMapping. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author richard
 * @see CustomerMacMappingLocalServiceUtil
...
public interface CustomerMacMappingLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CustomerMacMappingLocalServiceUtil} to access the customer mac mapping local service. Add custom service methods to {@link com.cmcti.cmts.domain.service.impl.CustomerMacMappingLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
