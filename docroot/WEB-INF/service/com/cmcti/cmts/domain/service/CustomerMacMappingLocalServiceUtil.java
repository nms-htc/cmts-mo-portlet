...
/**
 * Provides the local service utility for CustomerMacMapping. This utility wraps
 * {@link com.cmcti.cmts.domain.service.impl.CustomerMacMappingLocalServiceImpl} and is the
 ...
 * @see com.cmcti.cmts.domain.service.impl.CustomerMacMappingLocalServiceImpl
 * @generated
 */
public class CustomerMacMappingLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.cmcti.cmts.domain.service.impl.CustomerMacMappingLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.cmcti.cmts.domain.model.CustomerMacMapping addCustomerMacMapping(
		com.cmcti.cmts.domain.model.CustomerMacMapping customerMacMapping)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addCustomerMacMapping(customerMacMapping);
	}
	...
	*/
	public static com.cmcti.cmts.domain.model.CustomerMacMapping createCustomerMacMapping(
		long customerMacId) {
		return getService().createCustomerMacMapping(customerMacId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.cmcti.cmts.domain.model.CustomerMacMapping deleteCustomerMacMapping(
		long customerMacId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteCustomerMacMapping(customerMacId);
	}
	...
	*/
	public static com.cmcti.cmts.domain.model.CustomerMacMapping deleteCustomerMacMapping(
		com.cmcti.cmts.domain.model.CustomerMacMapping customerMacMapping)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteCustomerMacMapping(customerMacMapping);
	}
	...
	*/
	...
	public static com.cmcti.cmts.domain.model.CustomerMacMapping fetchCustomerMacMapping(
		long customerMacId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchCustomerMacMapping(customerMacId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.cmcti.cmts.domain.model.CustomerMacMapping getCustomerMacMapping(
		long customerMacId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getCustomerMacMapping(customerMacId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.cmcti.cmts.domain.model.CustomerMacMapping> getCustomerMacMappings(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getCustomerMacMappings(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getCustomerMacMappingsCount()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.cmcti.cmts.domain.model.CustomerMacMapping updateCustomerMacMapping(
		com.cmcti.cmts.domain.model.CustomerMacMapping customerMacMapping)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateCustomerMacMapping(customerMacMapping);
	}
	...
	*/
	...
	public static CustomerMacMappingLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					CustomerMacMappingLocalService.class.getName());

			if (invokableLocalService instanceof CustomerMacMappingLocalService) {
				_service = (CustomerMacMappingLocalService)invokableLocalService;
			}
			else {
				_service = new CustomerMacMappingLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(CustomerMacMappingLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(CustomerMacMappingLocalService service) {
	}

	private static CustomerMacMappingLocalService _service;
}