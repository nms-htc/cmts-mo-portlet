 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the {@link com.cmcti.cmts.domain.service.OptionLocalService} interface.
 *
 * <p>
...
public class OptionLocalServiceImpl extends OptionLocalServiceBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this interface directly. Always use {@link com.cmcti.cmts.domain.service.OptionLocalServiceUtil} to access the option local service.
	 */
	
	public Option updateOption(String optionKey, String optionType, String optionValue, String description, ServiceContext serviceContext) throws PortalException, SystemException {
