...
import com.cmcti.cmts.domain.service.CustomerMacMappingLocalService;
...
/**
 * Provides the base implementation for the customer mac mapping local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.cmcti.cmts.domain.service.impl.CustomerMacMappingLocalServiceImpl}.
 * </p>
 *
 * @author richard
 ...
 * @generated
 */
public abstract class CustomerMacMappingLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CustomerMacMappingLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.cmcti.cmts.domain.service.CustomerMacMappingLocalServiceUtil} to access the customer mac mapping local service.
	 */
	...
	@Override
	public CustomerMacMapping addCustomerMacMapping(
		CustomerMacMapping customerMacMapping) throws SystemException {
		customerMacMapping.setNew(true);

		return customerMacMappingPersistence.update(customerMacMapping);
	}
	 ...
	 */
	@Override
	public CustomerMacMapping createCustomerMacMapping(long customerMacId) {
		return customerMacMappingPersistence.create(customerMacId);
	}
	...
	@Override
	public CustomerMacMapping deleteCustomerMacMapping(long customerMacId)
		throws PortalException, SystemException {
		return customerMacMappingPersistence.remove(customerMacId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CustomerMacMapping deleteCustomerMacMapping(
		CustomerMacMapping customerMacMapping) throws SystemException {
		return customerMacMappingPersistence.remove(customerMacMapping);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CustomerMacMapping.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return customerMacMappingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return customerMacMappingPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CustomerMacMapping fetchCustomerMacMapping(long customerMacId)
		throws SystemException {
		return customerMacMappingPersistence.fetchByPrimaryKey(customerMacId);
	}
	 ...
	 */
	@Override
	public CustomerMacMapping getCustomerMacMapping(long customerMacId)
		throws PortalException, SystemException {
		return customerMacMappingPersistence.findByPrimaryKey(customerMacId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return customerMacMappingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CustomerMacMapping> getCustomerMacMappings(int start, int end)
		throws SystemException {
		return customerMacMappingPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCustomerMacMappingsCount() throws SystemException {
		return customerMacMappingPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CustomerMacMapping updateCustomerMacMapping(
		CustomerMacMapping customerMacMapping) throws SystemException {
		return customerMacMappingPersistence.update(customerMacMapping);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.cmcti.cmts.domain.model.CustomerMacMapping",
			customerMacMappingLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = customerMacMappingPersistence.getDataSource();
	...
	private CustomerMacMappingLocalServiceClpInvoker _clpInvoker = new CustomerMacMappingLocalServiceClpInvoker();
}