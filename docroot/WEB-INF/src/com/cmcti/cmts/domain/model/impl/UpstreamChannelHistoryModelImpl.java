...
/**
 * The base model implementation for the UpstreamChannelHistory service. Represents a row in the &quot;CMTS_UCHis&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class UpstreamChannelHistoryModelImpl extends BaseModelImpl<UpstreamChannelHistory>
	 ...
	 */
	public static final String TABLE_NAME = "CMTS_UCHis";
	public static final Object[][] TABLE_COLUMNS = {
			{ "ucHisId", Types.BIGINT },
			{ "cmtsId", Types.BIGINT },
	...
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.cmcti.cmts.domain.model.UpstreamChannelHistory"),
			true);
	...
	public static UpstreamChannelHistory toModel(
		...
		model.setUcHisId(soapModel.getUcHisId());
	...
	public ExpandoBridge getExpandoBridge() {
		return ExpandoBridgeFactoryUtil.getExpandoBridge(0,
			UpstreamChannelHistory.class.getName(), getPrimaryKey());
	}
	...
	public Object clone() {
		...
		upstreamChannelHistoryImpl.setUcHisId(getUcHisId());
		...
		upstreamChannelHistoryImpl.setAvgOnlineCmDsSNR(getAvgOnlineCmDsSNR());
	...
	public void resetOriginalValues() {
		UpstreamChannelHistoryModelImpl upstreamChannelHistoryModelImpl = this;

		upstreamChannelHistoryModelImpl._originalCmtsId = upstreamChannelHistoryModelImpl._cmtsId;

		upstreamChannelHistoryModelImpl._setOriginalCmtsId = false;

		upstreamChannelHistoryModelImpl._originalIfIndex = upstreamChannelHistoryModelImpl._ifIndex;

		upstreamChannelHistoryModelImpl._setOriginalIfIndex = false;

		upstreamChannelHistoryModelImpl._columnBitmask = 0;
	}
	...
	public CacheModel<UpstreamChannelHistory> toCacheModel() {
		...
		upstreamChannelHistoryCacheModel.ucHisId = getUcHisId();
		...
		upstreamChannelHistoryCacheModel.avgOnlineCmDsSNR = getAvgOnlineCmDsSNR();
