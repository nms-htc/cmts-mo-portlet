...
/**
 * The base model implementation for the CableModemHistory service. Represents a row in the &quot;CMTS_CMHis&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class CableModemHistoryModelImpl extends BaseModelImpl<CableModemHistory>
	 ...
	 */
	public static final String TABLE_NAME = "CMTS_CMHis";
	public static final Object[][] TABLE_COLUMNS = {
			{ "cmHisId", Types.BIGINT },
	...
	public static final String TABLE_SQL_CREATE = "create table CMTS_CMHis (cmHisId LONG not null primary key,macAddress VARCHAR(75) null,createDate DATE null,fecUncorrectable DOUBLE,fecCorrected DOUBLE,microRef LONG,rxPower INTEGER,txPower INTEGER,usPower INTEGER,dsPower INTEGER,uncorrectables LONG,correcteds LONG,unerroreds LONG,dsSNR INTEGER,usSNR INTEGER,ucIfIndex INTEGER,dcIfIndex INTEGER,cmSubIndex VARCHAR(75) null,cmtsId LONG,cmIndex INTEGER,status INTEGER)";
	public static final String TABLE_SQL_DROP = "drop table CMTS_CMHis";
	public static final String ORDER_BY_JPQL = " ORDER BY cableModemHistory.createDate DESC";
	public static final String ORDER_BY_SQL = " ORDER BY CMTS_CMHis.createDate DESC";
	...
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.cmcti.cmts.domain.model.CableModemHistory"),
			true);
	public static long CMTSID_COLUMN_BITMASK = 1L;
	public static long MACADDRESS_COLUMN_BITMASK = 2L;
	...
	public static CableModemHistory toModel(CableModemHistorySoap soapModel) {
		...
		model.setCmHisId(soapModel.getCmHisId());
	...
	public ExpandoBridge getExpandoBridge() {
		return ExpandoBridgeFactoryUtil.getExpandoBridge(0,
			CableModemHistory.class.getName(), getPrimaryKey());
	}
	...
	public Object clone() {
		...
		cableModemHistoryImpl.setCmHisId(getCmHisId());
	...
	public void resetOriginalValues() {
		CableModemHistoryModelImpl cableModemHistoryModelImpl = this;

		cableModemHistoryModelImpl._originalMacAddress = cableModemHistoryModelImpl._macAddress;

		cableModemHistoryModelImpl._originalCmtsId = cableModemHistoryModelImpl._cmtsId;

		cableModemHistoryModelImpl._setOriginalCmtsId = false;

		cableModemHistoryModelImpl._columnBitmask = 0;
	}
	...
	public CacheModel<CableModemHistory> toCacheModel() {
		...
		cableModemHistoryCacheModel.cmHisId = getCmHisId();
